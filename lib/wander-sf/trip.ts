    ...
    },
    {
      ...
      segments: [
        ...
        { id: "d4-palace", time: "7:45 PM", isAnchor: true, anchorLabel: "GOLDEN HOUR", transit: { label: "Car to the Marina · ≈15 min" },
          options: [ P("Palace of Fine Arts", "VIEW", "Must-see", "Marina", "palace", { match: "Blue hour is the shot", hours: "Grounds always open · free", price: "Free", why: "Golden hour is 7:41, sunset 8:18, blue hour to 8:47 — the floodlit rotunda mirrored in the lagoon is the picture. Ten minutes from a fully gluten-free dinner at Camino Alto.", lat: 37.803, lng: -122.4485, web: "https://palaceoffinearts.org/" }),
...
const optionalIdeas: OptionalIdea[] = [
  ...
  { name: "Little Gem", cat: "Dining", neigh: "Hayes Valley", why: "Entirely gluten-, dairy- and refined-sugar-free and casual — a genuinely celiac-safe sit-down lunch or dinner near Civic Center and SFJAZZ.", weather: "any", img: uimg(IMG.satHero), seed: "dinner5", lat: 37.7776, lng: -122.4231 },
  ...
  { name: "The Coffee Movement (breakfast)", cat: "Cafés", neigh: "one block from the hotel", why: "Your closest excellent cup for the morning ritual — 10-min walk, opens 7. Coffee-forward (no GF food), so pair with a Mariposa or Sisterita pastry.", weather: "any", img: uimg(IMG.chinatown), seed: "cafe5", lat: 37.7945, lng: -122.4085 },
  ...
  { name: "Kitava", cat: "Dining", neigh: "Mission", why: "100% gluten-, dairy- and refined-sugar-free fast-casual — bibimbap and GF fried chicken, no reservation needed. A safe, low-drama meal.", weather: "any", img: uimg(IMG.mission), seed: "dinner7", lat: 37.7638, lng: -122.4193 },
