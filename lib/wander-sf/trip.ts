...
function buildDays(): Day[] {
  return [
    ...
    },
    {
      ...
      title: "Coffee on Polk, an Irish coffee at the Buena Vista, an hour at The Interval, the waterfront on foot, then a romantic Italian dinner by the hotel.",
      ...
      segments: [
        ...
        { id: "d3-din", time: "7:30 PM", isAnchor: true, anchorLabel: "ROMANTIC DINNER", transit: { label: "Two minutes from the JW Marriott — Post & Mason" },
          options: [ P("Zingari Ristorante", "DINNER", "Dining", "501 Post St · Union Square", "nightSkyline", { diet: { level: "caution", label: "GF pasta — confirm celiac" }, rating: { value: 4.5 }, match: "Fancy + romantic, a block from the hotel", hours: "Sun 12:00 PM – 9:45 PM (last seating)", price: "$$$", why: "A white-tablecloth Italian dining room and jazz bar just off Union Square — frescoed private rooms, a candle-lit wine cellar, and live jazz nightly from 8pm. The romantic close to the day, two minutes from the JW Marriott.", lat: 37.7883, lng: -122.4108, web: "https://www.zingari.com/", book: "tel:+14158858850", source: "Zingari / OpenTable", verifiedOn: "Aug 2, 2026", uncertainty: "GF pasta is available but it's not a dedicated gluten-free kitchen — confirm celiac cross-contact when you reserve: (415) 885-8850." }) ] },
        { id: "d3-cat", time: "9:30 PM", isAnchor: true, anchorLabel: "LATE JAZZ SET", transit: { label: "Take a car — Tenderloin at night" },
          options: [ P("Black Cat — Denim Dream", "JAZZ", "Must-see", "Tenderloin", "nightSkyline", { match: "Optional — Zingari already has jazz", hours: "Sun 6:00 PM – 11:00 PM · sets 7 & 9:30", price: "$$$", why: "Daniel Winshall & PHER's 'Denim Dream' residency plays sets at 7 and 9:30pm — a lovely set, but it's across town in the Tenderloin, and Zingari already has live jazz from 8pm right by the hotel. So treat this as optional: head over for the 9:30 set if you want more, or keep the night romantic and close and skip it.", lat: 37.784, lng: -122.413, book: "tel:+14153581999", web: "https://blackcatsf.com/", dietNote: "You'll have eaten at Zingari; if you go, take a car both ways." }) ] },
      ],
    },
    {
