...
const optionalIdeas: OptionalIdea[] = [
  ...
  { name: "Sisterita", cat: "Cafés", neigh: "Jackson Square", why: "From the XICA team — a gluten-free breakfast and lunch spot, and your safe morning option away from the hotel. Reserve on weekends.", weather: "any", img: uimg(IMG.cafe2), seed: "cafe4", lat: 37.7949, lng: -122.4033 },
  { name: "The Coffee Movement (breakfast)", cat: "Cafés", neigh: "one block from the hotel", why: "Your closest excellent cup for the morning ritual — 10-min walk, opens 7. Coffee-forward (no GF food), so pair with a Mariposa or Sisterita pastry.", weather: "any", img: uimg(IMG.cafe), seed: "cafe5", lat: 37.7945, lng: -122.4085 },
  { name: "fckgltn (dedicated GF pizza)", cat: "Dining", neigh: "Mission Bay", why: "Dedicated gluten-free (and vegan) pizza, bowls and salads — safe pizza is rare in SF. More takeout than ambiance, handy near Oracle Park.", weather: "any", img: uimg(IMG.dinner), seed: "dinner6", lat: 37.7695, lng: -122.3969 },
  { name: "Kitava", cat: "Dining", neigh: "Mission", why: "100% gluten-, dairy- and refined-sugar-free fast-casual — bibimbap and GF fried chicken, no reservation needed. A safe, low-drama meal.", weather: "any", img: uimg(IMG.dinner2), seed: "dinner7", lat: 37.7638, lng: -122.4193 },
  { name: "Lands End Trail", cat: "Outdoors", neigh: "Lincoln Park", why: "The best coastal walk in the city — cliffs, cypress, the Sutro Baths ruins and framed Golden Gate views. Pairs with a Legion of Honor morning.", weather: "clear", img: uimg(IMG.garden), seed: "garden4", lat: 37.7807, lng: -122.5057 },
  { name: "Twin Peaks", cat: "Must-see", neigh: "central SF", why: "The 360-degree view over the whole city — best late afternoon before the fog, or after dark for the grid of lights. A quick car up from downtown.", weather: "clear", img: uimg(IMG.skyline), seed: "skyline2", lat: 37.7544, lng: -122.4477 },
  { name: "Lombard St (crooked street)", cat: "Must-see", neigh: "Russian Hill", why: "The eight-hairpin block on Hyde — your Powell/Hyde cable car passes the top at Hyde & Lombard, so it slots straight into the Saint Frank morning.", weather: "any", img: uimg(IMG.cable), seed: "cable2", lat: 37.8021, lng: -122.4187 },
  { name: "Sausalito ferry", cat: "Outdoors", neigh: "from the Ferry Building", why: "A half-day escape — ferry across the bay past Alcatraz to the waterfront village of Sausalito, lunch, and back. Golden Gate or Blue & Gold ferry.", weather: "clear", img: uimg(IMG.view), seed: "view3", lat: 37.8558, lng: -122.4787 },
  ...
  { name: "Coit Tower & Filbert Steps", cat: "Must-see", neigh: "Telegraph Hill", why: "WPA murals inside, a 360-degree view up top, and the wild-parrot garden stairways down — great with a North Beach evening.", weather: "clear", img: uimg(IMG.view), seed: "view4", lat: 37.8024, lng: -122.4058 },
  { name: "Fisherman's Wharf & Pier 39", cat: "Must-see", neigh: "the waterfront", why: "Touristy but iconic — the sea lions at Pier 39 — and it sits directly on your Sunday Embarcadero walk, so it costs nothing extra.", weather: "any", img: uimg(IMG.market), seed: "market5", lat: 37.8087, lng: -122.4098 },
  { name: "Golden Gate Park", cat: "Outdoors", neigh: "west of the city", why: "The Japanese Tea Garden, Botanical Garden and Stow Lake wrap around the de Young — pair it with the Tuesday museum morning.", weather: "clear", img: uimg(IMG.garden), seed: "garden5", lat: 37.7694, lng: -122.4862 },
  { name: "Asian Art Museum", cat: "Art & Culture", neigh: "Civic Center", why: "Free the first Sunday of the month — Aug 2 qualifies — a calm, world-class indoor option if the fog wins that day.", weather: "rain", img: uimg(IMG.gallery), seed: "gallery4", lat: 37.7800, lng: -122.4163 },
];
