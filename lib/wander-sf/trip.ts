...
const IMG: Record<string, string> = {
  ...
  monHero: "/photos/pinot-grapes.jpg", // Carrie's Pinot Noir grapes on the vine
  roche: "/photos/roche.jpg", // Carrie's Roche Winery entrance
  rocheBarrel: "/photos/roche-barrel.jpg", // Carrie's Roche barrel room / Our Lady of Carneros mural
  ...
  return [
    ...
    },
    {
      ...
      segments: [
        ...
        { id: "d3-chinatown", time: "11:30 AM", isAnchor: true, anchorLabel: "CHINATOWN WALK", transit: { label: "A block from the hotel — the Grant Ave gate" }, leaveBy: "12:45 PM",
          options: [ P("Chinatown — Grant Ave & the alleys", "NEIGHBOURHOOD", "Must-see", "Grant Ave · Chinatown", "chinatown", { match: "Lanterns, the dragon gate, Ross Alley", hours: "Streets always open · free", price: "Free", why: "The oldest Chinatown in North America starts a block from the hotel — the Grant Ave dragon gate, red lanterns strung overhead, Waverly Place, and Ross Alley with its fortune-cookie factory. A perfect late-morning wander.", lat: 37.7941, lng: -122.4078, web: "https://www.sanfranciscochinatown.com/", source: "Carrie's trip", verifiedOn: "Aug 3, 2026", dietNote: "Browse rather than eat if you're celiac — Chinese soy sauce is wheat-based." }) ] },
        ...
        { id: "d3-wizards", time: "2:00 PM", isAnchor: true, anchorLabel: "WIZARDING BAR", transit: { label: "Marina District — 2030 Lombard St" }, leaveBy: "3:00 PM",
          options: [ P("Wizards & Wands", "BAR", "Trending", "2030 Lombard St · Marina", "nightSkyline", { diet: { level: "caution", label: "Cocktails GF — check the food" }, rating: { value: 4.4 }, match: "Immersive wizarding cocktails", hours: "Afternoon – late · reserve on weekends", price: "$$", why: "An immersive Harry-Potter-style wizarding bar in the Marina — themed potions and cocktails in a wand-and-spellbook world, a fun detour on the way toward Fort Mason.", lat: 37.7998, lng: -122.436, web: "https://www.google.com/search?q=Wizards+and+Wands+San+Francisco", source: "OpenTable / KRON4", verifiedOn: "Aug 3, 2026", dietNote: "Cocktails are gluten-free; ask about the themed food if you're celiac." }) ] },
    ...
    },
    {
      ...
      title: "Over the Golden Gate to Sonoma wine country — first pour at Roche — back for the floodlit rotunda at dusk.",
      ...
      segments: [
        { id: "d4-bridge", time: "9:30 AM", isAnchor: true, anchorLabel: "GOLDEN GATE CROSSING", transit: { label: "North over the bridge toward Marin & Sonoma" }, leaveBy: "10:15 AM",
          options: [ P("Golden Gate Bridge", "VIEW", "Must-see", "Marin vista point", "ggb", { match: "The wine day starts here", hours: "Always open · free", price: "Free", why: "Head north across the Golden Gate and pull off at the Marin-side vista point for the classic look back at the span and the city. From here it's about 40 minutes up through Carneros to your first pour at Roche.", lat: 37.8329, lng: -122.4799, web: "https://www.goldengate.org/", source: "Carrie's trip", verifiedOn: "Aug 3, 2026" }) ] },
        { id: "d4-roche", time: "10:45 AM", isAnchor: true, anchorLabel: "FIRST WINE STOP", transit: { label: "Straight after the bridge — up through Carneros, ~40 min" }, leaveBy: "12:15 PM",
          options: [ P("Roche Winery & Vineyards", "WINE TASTING", "Outdoors", "22097A Bonness Rd · Carneros, Sonoma", "roche", { rating: { value: 4.6 }, match: "First stop after the bridge — the gateway into Sonoma", hours: "Daily 10:30 AM – 5:00 PM", price: "$$", why: "Your first pour of the day — the Roche family's estate on the Carneros valley floor, the first winery you reach coming up from the city. Tastings on an indoor–outdoor plaza with fire pits and farm tables — Pinot Noir is their grape, classic cool-climate Carneros Pinot, with Chardonnay alongside. Walk-ins are welcome, but reserve to be safe: (707) 935-7115.", lat: 38.243, lng: -122.487, web: "https://www.rochewinery.com/", book: "https://www.rochewinery.com/reservations", source: "rochewinery.com", verifiedOn: "Aug 3, 2026", dietNote: "Wine is naturally gluten-free; carry a GF snack for between tastings." }),
                     P("Roche — the barrel room", "WINE TASTING", "Outdoors", "Inside the Carneros estate", "rocheBarrel", { match: "Step inside — Our Lady of Carneros", hours: "Daily 10:30 AM – 5:00 PM", price: "$$", why: "Step inside the estate: oak barrels of Pinot and Merlot beneath the winery's hand-painted 'Our Lady of Carneros' mural, the valley's hills wrapping the room. The heart of the tasting.", lat: 38.243, lng: -122.487, web: "https://www.rochewinery.com/", source: "Carrie's trip", verifiedOn: "Aug 3, 2026", dietNote: "Wine is naturally gluten-free." }) ] },
