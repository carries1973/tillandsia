...

    {
      ...
      segments: [
        ...
        },
        {
          id: "d2-din",
          time: "5:30 PM",
          transit: { label: "Green line up to the Plateau · ≈20 min" },
          leaveBy: "6:30 PM",
          optionMeta: {
            need: "Pre-show dinner — dedicated GF first",
            notes:
              "No dedicated-GF kitchen sits at the arena, so eat the real meal early at a dedicated spot, then head down to the Bell Centre. Or trade some safety for a sit-down closer to the venue.",
          },
          options: [
            P("La Bolo à Lolo", "DINNER", "Dining", "Plateau", "penne", {
              diet: { level: "safe", label: "Dedicated & certified GF" },
              rating: { value: 5.0 },
              match: "Safest GF · concert night",
              price: "$–$$",
              hours: "Casual / takeout-style · eat by ~6:15",
              why: "The safest-feeling table in the city — the owner is celiac and nothing risky is on the premises — and cheap. Eat here first in the Plateau, then take the Green line down to the Bell Centre with room to spare.",
              review: "Universally loved; handles no gluten, nuts, shellfish or pork.",
              tradeoff: "Fully dedicated & safest — eat early, then head to the venue.",
              lat: 45.527,
              lng: -73.585,
              web: "https://laboloalolo.com/",
              book: "https://laboloalolo.com/",
            }),
            P("Nora Gray", "DINNER", "Dining", "Griffintown", "pasta", {
              ...
              tradeoff: "Best sit-down experience near the venue — brief the kitchen.",
              lat: 45.493,
              lng: -73.571,
